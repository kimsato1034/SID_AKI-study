...
-- first 24 hrs
--  min
, MIN(CASE WHEN chartoffset between -6*60 AND 24*60 AND fio2 IS NOT NULL THEN fio2 END) AS fio2_min_24
...
, MIN(CASE WHEN chartoffset between -6*60 AND 24*60 AND peep IS NOT NULL THEN peep END) AS peep_min24
-- max
, MIN(CASE WHEN chartoffset between -6*60 AND 48*60 AND fio2 IS NOT NULL THEN fio2 END) AS fio2_min_48
...
, MIN(CASE WHEN chartoffset between -6*60 AND 48*60 AND peep IS NOT NULL THEN peep END) AS peep_min_48
-- first 48 hrs
--  min
, MAX(CASE WHEN chartoffset between -6*60 AND 24*60 AND fio2 IS NOT NULL THEN fio2 END) AS fio2_max_24
...
, MAX(CASE WHEN chartoffset between -6*60 AND 24*60 AND peep IS NOT NULL THEN peep END) AS peep_max24
--  max
, MAX(CASE WHEN chartoffset between -6*60 AND 48*60 AND fio2 IS NOT NULL THEN fio2 END) AS fio2_max_48
...
, MAX(CASE WHEN chartoffset between -6*60 AND 48*60 AND peep IS NOT NULL THEN peep END) AS peep_max_48
