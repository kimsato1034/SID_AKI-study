...
```{r}
df_me_selected['id']<- seq.int(nrow(df_me_selected))
```
...
train_idx <- createDataPartition(as.factor(df_me_selected$aki), times = 1, p = 0.75, list=F)
train <- df_me_selected[train_idx, ]
test <- df_me_selected[-train_idx, ]
