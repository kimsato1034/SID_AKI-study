...
baseline_creat<-run_query(getSQL("baseline_creat.sql"))
chronicAKI<-run_query(getSQL("chronicAKI.sql"))
first_rrt<-run_query(getSQL("first_rrt.sql"))
peakcreat48h<-run_query(getSQL("peakcreat48h.sql"))
peakcreat7days<-run_query(getSQL("peakcreat7days.sql"))
...
sid_aki<-Reduce(function(...) merge(..., all.x=TRUE), list(
 demographics.sql
, bg_24_48.sql
, bg_first.sql
, lab_24_48.sql
...
, temp_day1.sql
, temp_day2.sql
, urine_output_24_48.sql
, vent_bin_first_2days.sql
, vitals_day1.sql
, vitals_day2.sql
, AKIlist_final
))
